...
\begin{enumerate}
    ...
    \item[13.] (Variación) \textit{Dadas $f : I \subset \mathbb{R} \rightarrow \mathbb{R}$ y $g : J \subset \mathbb{R} \rightarrow \mathbb{R}$ funciones continuas, supongamos que $g(0) = 0$ y $g(x) \leq x$ en un entorno de $x = 0$. Probar que la única solución del problema de Cauchy}
