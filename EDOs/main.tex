...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item[\textit{(e)}] \textit{Sea $a : \mathbb{R} \rightarrow \mathbb{R}$ una función continua y supongamos que existe $t_0 \in \mathbb{R}$ tal que $a(t) \leq 1/t^2$ para todo $t > t_0$. Probar que cualquier solución de la EDO $x' = a(t)x$ cumple $\lim_{t \to \infty} x(t) < \infty$. ¿Es cierto si se impone $a(t) \leq 1/t$?}
    \end{enumerate}
\end{enumerate}
