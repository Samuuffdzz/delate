...
\begin{itemize}
    ...
    \item \textit{Sean $u_1, u_2, ..., u_n, u_1^2 + u_2^2 + \cdots + u_n^2 : D \subset \mathbb{R}^2 \to \mathbb{R}$ funciones armónicas sobre una región $D$. Probar que cada $u_k$ es constante sobre $D$.}

    \vspace{5px}

    \textsc{Demostración}: ¿Acaso no es obvio?
\end{itemize}
