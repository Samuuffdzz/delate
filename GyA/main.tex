...
\begin{enumerate}
    ...
    Al tratar la unicidad, notamos que todo ideal propio debe estar contenido\footnote{Si un ideal $J$ posee un elemento invertible, entonces $J = A$.} en $I$. Como, por definición, todo ideal $J$ maximal es propio, inferimos que $J \subseteq I$. Concluimos así final y rotundamente que $J = I$ y, por tanto, $I$ es único. \hfill{\textsc{Q.e.d.}}
\end{enumerate}
