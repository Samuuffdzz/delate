...
Sean $b_i, 1 \leq i \leq n$, numeros reales positivos cuyo producto es 1.

$a)$ Demuestre que si no todos los $b_i$ son iguales y están ordenados de forma creciente, entonces $b_1 < 1 < b_n$.

\textbf{Dem:} Por reducción al absurdo, si asuminos que todos son menores 
